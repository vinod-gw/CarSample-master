...
public class EditRatingView extends PopupViewWithUiHandlers<EditRatingUiHandlers> implements MyView, Editor<Rating> {
    ...
    @Inject
    public EditRatingView(final Binder uiBinder, final Driver driver, final EventBus eventBus,
            final UiHandlersStrategy<EditRatingUiHandlers> uiHandlersStrategy) {
